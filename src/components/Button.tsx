  ...
  return (
    <div>
      <button
        ...
        className={clsx(
          'flex justify-center items-center gap-2 px-6 py-3 rounded-3xl transition-all duration-200 border-2 border-solid border-transparent focus:outline-none focus:border-purple-100 font-sans font-medium text-sm',
          {
            'cursor-default':
